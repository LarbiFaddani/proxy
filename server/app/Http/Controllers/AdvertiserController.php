...
class AdvertiserController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       /* $Adver = Advertiser::select('u.id as user_id','u.email','ac.id', 'u.status', 'u.name', 'u.phone','u.password', 'u.address','u.created_at', 'u.updated_at')
        ->from('users as u')
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            'act_name'=>'bail|required|string|min:5|max:45'
...
return response()->json(['message' => 'advertiser updated'], 200);
   ...
   /* public function destroy(string $id)
    ...
    $adv->delete();
     return response()->json(['message'=>' advertiser is  deleted successfully']);
